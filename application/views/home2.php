...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-5">
			...
			<img alt="" class="center" src="<?php echo base_url();?>static/img/logo.webp" width="250" height="150">
			<br>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-4">
			...
			<div class="background-blue rounded mx-5 hover-pointer provide-services">
				<img alt="" class="center img-responsive" src="<?php echo base_url();?>static/img/home/worker.webp" height="200">
			</div>
		...
		<div class="col-xs-12 col-md-4">
			...
			<div class="background-white rounded mx-5">
				<img title="https://www.freepik.es/fotos/negocios" class="center trusted-people img-responsive" src="<?php echo base_url();?>static/img/home/handshake.webp" height="200">
			</div>
			<p class="mx-5">Para brindar seguridad al usuario final, nos aseguramos de conocer al personal anunciado.</p>
			<br>
		</div>
	</div>
</div>
